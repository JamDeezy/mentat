...
(function (flipp) {
    ...
    (function (mentat) {
        var Bars = (function (_super) {
            ...
            Bars.prototype.detachedCallback = function () {
                if (this._tip)
                    this._tip.remove();
            };
            ...
            Object.defineProperty(Bars.prototype, "sorted", {
                get: function () {
            ...
            Object.defineProperty(Bars.prototype, "vertical", {
                get: function () {
            ...
            Bars.prototype.render = function () {
                ...
                if (this.data && this.data.length > 0) {
                    ...
                    if (!this.normalized) {
                        if (this.vertical) {
                            y.domain([d3.max(data, function (d) { return d.total; }), 0]);
                        }
                        else {
                    ...
                    if (this.vertical) {
                        ...
                        var bucket = svg.selectAll(".bucket")
                            ...
                            return _this.translate(0, x(d.bucket));
                        });
